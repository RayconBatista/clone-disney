<template>
  <div class="min-h-screen bg-cover" :style="{ backgroundImage: `url('${background}')` }">
    <div class="pt-32 pl-8 mb-2">
      <img src="@/assets/images/captain_marvel_logo.png" alt="logo" class="w-96">
    </div>
    ...
    <!-- <img src="@/assets/images/captain_marvel_background.jpeg" alt="captain marvel"> -->
  </div>
</template>
...
export default {
  data() {
    return {
      background: require('@/assets/images/captain_marvel_bg.jpeg')
    }
  }
}
</script>
